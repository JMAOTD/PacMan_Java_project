...
/**
 * klasa odpowiadająca za utworzenie bonusu immunitetu,
 * gracz wtedy bez umierania może kolidować z duchami
 */
public class Bonus_Imunity extends BonusCreator implements Runnable{
    ...
    public Bonus_Imunity(GamePanelMain gp, int yIndex, int xIndex){
    ...
    private void AvailableToPickTimer(){
        ...
        if(gp.bc.bonusMap[yIndex][xIndex] == 1) {
